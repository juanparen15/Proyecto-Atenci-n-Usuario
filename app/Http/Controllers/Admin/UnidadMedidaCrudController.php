...
class UnidadMedidaCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/unidad-medida');
        CRUD::setEntityNameStrings('unidad medida', 'unidad medidas');
    }
    ...
    {
        CRUD::setValidation(UnidadMedidaRequest::class);
